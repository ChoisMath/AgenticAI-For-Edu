...
> 교수학습자료 중 학생의 사고를 유발하는 읽기자료, 예상-확인-설명-재해석을 위한 학생 활동지 제작, 학생의 탐구를 유도하는 시각화 자료, 학생을 의사결정자의 자리에 세우는 사례 및 상황제시문, 사실확인 및 편향, 저작권, 학생정합성 등 비평가를 활용한 점검 skill을 제공합니다.
